"""
Download Script Provided by Source
Usage: python2 downloadWaterData_PythonV3.py DESTINATION_FOLDER DATASET_NAME
"""
...
def main(argv):
   ...
   DATASET_NAME = argv[1]
   longs = [str(w) + "W" for w in [60]] #range(180,0,-10)]
   #longs.extend([str(e) + "E" for e in range(0,180,10)])
   lats = []#[str(s) + "S" for s in range(50,0,-10)]
   lats.extend([str(n) + "N" for n in [0]]) #range(0,90,10)])
